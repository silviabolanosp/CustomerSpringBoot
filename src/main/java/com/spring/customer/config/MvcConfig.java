...
import com.spring.customer.annotations.EmailValidator;
import com.spring.customer.annotations.PasswordMatchesValidator;
...
@Configuration
@ComponentScan(basePackages = { "com.spring.customer.web" })
@EnableWebMvc
